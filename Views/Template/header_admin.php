...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= media(); ?>/css/bootstrap-datepicker.css">
  ...
  <div id="divLoading">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">S O D</a>
