...
<body>
	<table align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="text-align:center;">
		<tbody>
			...
			<tr>
				<td>
					<img src="<?= base_url(); ?>/Assets/images/michoacan.jpg" class="x_text_left">
					<br><br><br>
					<p class="x_text_aling">Enviado el dia <strong><?= $data['fecha_emision']; ?></strong></p>
					<div class="x_sgwrap">
						<p>Hola <?= $data['plantelRecibe']; ?></p>
					</div>
					...
					<br><br>
					<img src="<?= base_url(); ?>/Assets/images/cecytem.jpg" class="x_text_right">
					<br><br><br>
